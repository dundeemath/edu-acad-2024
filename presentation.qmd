...
Our premise: if this can be achieved in a mathematics module, it can be achieved anywhere!
...
ui <- page_sidebar(
  ...
  navset_card_underline(
    # nav_panel("True ages", tableOutput("truth")),
...
- We've highlighted learning design efforts in Mathematics to embed experiential learning activities aligned with intended learning outcomes in our undergraduate modules.
